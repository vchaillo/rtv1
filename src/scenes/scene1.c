...
/*   Updated: 2017/01/07 02:22:30 by valentinchaillou89###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	add_object(scene, new_object(SPHERE, new_sphere(0, 0, 0, 3),
		new_color(PASTEL_BLUE), 100));
	add_object(scene, new_object(PLANE, new_plane(0, 1, 0, 1),
