...
/*   Updated: 2017/01/05 03:02:05 by valentinchaillou89###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			load_scene2_lights(t_scene *scene)
{
	...
	add_light(scene, new_light(SPOT, 1, new_vector(-10, 10, 5), new_color(RED)));
	add_light(scene, new_light(SPOT, 1, new_vector(10, 10, 5), new_color(BLUE)));
	add_light(scene, new_light(SPOT, 1, new_vector(0, 10, 10), new_color(GREEN)));
}
...
void			load_scene2(t_env *e)
{
	...
	e->scene = new_scene(new_color(BLACK), new_camera(0, 5, 30));
